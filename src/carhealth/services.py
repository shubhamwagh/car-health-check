    ...
    for _ in range(5):
        ...
        if resp.status_code == 429:
            ...
            if body.get("code") == "quota_exhausted":
                ...
                resets = fmt_date(body.get("resets")) if body.get("resets") else "later this month"
                return {
                    "error": f"Vehicle intelligence data is temporarily unavailable "
                    f"(monthly limit reached) - available again from {resets}."
                }
